...
## Project Structure
    ...
    ├── tst_daniel_fimp_30504  # Django project configurations
...
1. Clone this repo and `cd tst_daniel_fimp_30504`
...
2. Clone this repo and `cd tst_daniel_fimp_30504`
